...
class TouristPointResource(Resource):
    def get(self, id):
        ...
        if tourist_point:
            return jsonify(tourist_point)  # El objeto ya está serializado
